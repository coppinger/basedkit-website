...
/* src/icons/clover.svelte generated by Svelte v4.1.2 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "clover" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class Clover extends SvelteComponent {
	constructor(options) {
		super();
...
export { Clover$1 as default };
//# sourceMappingURL=clover.svelte.js.map
