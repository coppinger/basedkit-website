...
/* src/icons/hop-off.svelte generated by Svelte v4.1.2 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hop-off" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class Hop_off extends SvelteComponent {
	constructor(options) {
		super();
...
var Hop_off$1 = Hop_off;

export { Hop_off$1 as default };
//# sourceMappingURL=hop-off.svelte.js.map
