...
/* src/icons/hop.svelte generated by Svelte v4.1.2 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "hop" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class Hop extends SvelteComponent {
	constructor(options) {
		super();
...
export { Hop$1 as default };
//# sourceMappingURL=hop.svelte.js.map
