...
/* src/icons/dog.svelte generated by Svelte v4.1.2 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "dog" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class Dog extends SvelteComponent {
	constructor(options) {
		super();
...
export { Dog$1 as default };
//# sourceMappingURL=dog.svelte.js.map
