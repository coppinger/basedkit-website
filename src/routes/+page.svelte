...
BBBBBBBBBBBBBBBBB     aaaaaaaaaa  aaaa sssssssssss        eeeeeeeeeeeeee     ddddddddd   dddddKKKKKKKKK    KKKKKKKiiiiiiii         ttttttttttt  
    ...
    <p class="max-w-sm text-center">
        BasedKit is a free and open source boilerplate for building with
        Supabase (inc. Supabase CLI) and SvelteKit.
    </p>

    <Button href="https://github.com/coppinger/basedkit" target="_blank"
        >Get started 🚀</Button
    >
    ...
    <ol class="ml-2 flex max-w-sm list-decimal flex-col gap-8">
        <li>
            ...
            <ul
                class="mt-2 flex flex-col gap-1 rounded-md border border-neutral-700 p-4"
            >
        ...
        <li>
            <p>
                Replace 'project_id' in <code>supabase/config.toml</code> with your
                project ID.
            </p>
        </li>
    </ol>
    ...
    <Accordion.Root class="w-full max-w-sm">
        <Accordion.Item value="item-1">
            <Accordion.Trigger
                >Where can I find my Supabase keys?</Accordion.Trigger
            >
            <Accordion.Content
                >This boilerplate uses Supabase CLI (local), so you'll need both
                your remote keys from your Supabase project and your local keys
                from the Supabase CLI. To find the latter, run `supabase status`
                and copy they keys that print out in the terminal.</Accordion.Content
            >
        </Accordion.Item>
        <Accordion.Item value="item-2">
            <Accordion.Trigger
                >How can I change the Tailwind theme?</Accordion.Trigger
            >
            <Accordion.Content>
                Simply change the <code>'baseColor'</code> value in
                <code>components.json</code> to your desire color.
            </Accordion.Content>
        </Accordion.Item>
    </Accordion.Root>

    <Button
        href="https://github.com/coppinger/basedkit"
        target="_blank"
        variant="secondary">Contribute 💚</Button
    >
    <Button
        variant="outline"
        href="https://github.com/coppinger/basedkit/issues"
        target="_blank">Issues? Please report!</Button
    >
